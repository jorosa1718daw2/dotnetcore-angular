...
this.currentAnalogData = result;
    ...
    loadAll(sensor) {
        this.http.get(`http://192.168.10.19/api/Sensor/${sensor.sensorId}/CurrentAnalogData`).subscribe((data: CurrentAnalogData[]) => {
    ...
    load(sensor) {
        this.http.get<CurrentAnalogData>(`http://192.168.10.19/api/Sensor/${sensor.sensorId}/CurrentAnalogData`).subscribe((data: CurrentAnalogData) => {
            let notFound = true;
    ...
    update(currentanalogdata: CurrentAnalogData, sensor) {
        this.http.put(`http://192.168.10.19/api/Sensor/${sensor.sensorId}/CurrentAnalogData`, JSON.stringify(currentanalogdata))
